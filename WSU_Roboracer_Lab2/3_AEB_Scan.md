...
`(-135°)       (-90°)       (0° Front)       (+90°)       (+135°)    |------------|-------------|-------------|-------------|  Left Side      Left Front    Forward       Right Front   Right Side`
...
|---|---|
|Car stops for **any** obstacle|Car stops **only for obstacles in front**|
|Wall on **the right** triggers braking|Car ignores side walls|
|Driving next to a wall = **false stops**|Car moves smoothly near side obstacles|
...
|**Step**|**What It Does**|
|---|---|
|1️⃣ Compute angles|Maps each LiDAR reading to its corresponding angle|
|2️⃣ Filter front angles|Keeps only readings **within -20° to +20°**|
|3️⃣ Extract front distances|Only analyzes obstacles **directly in front**|
|4️⃣ Compute TTC|Uses these front readings for safety decisions|
|5️⃣ Stop only if necessary|The car won’t brake for side walls anymore|
